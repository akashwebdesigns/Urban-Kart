      ...
      * {
      ...
      @media (max-width: 480px) {
        ...
        #u_content_text_6 .v-container-padding-padding {
          padding: 51px 14px 10px 0px !important;
        }
      }
    </style>
                                  ...
                                  <tr>
                                    ...
                                    >
                                      <img
                                        align="center"
                                        border="0"
                                        src="https://assets.unlayer.com/stock-templates1672237263669-banner.png"
                                        alt="Image"
                                        title="Image"
                                        style="
                                          outline: none;
                                  ...
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      style="
                                        ...
                                        line-height: 19.6px;
                                      "
                                      >28 White tower, Los Santos, New York
                                      City, USA</span
                                    ><br /><span
                                      style="
                                        color: #ecf0f1;
